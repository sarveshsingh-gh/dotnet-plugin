...
function M.annotate_keys(km)
  local map = {
    ...
    -- Docker
    ["docker.scaffold"]         = km.docker_scaffold,
    ["docker.scaffold_all"]     = km.docker_scaffold_all,
    ["docker.scaffold_debug"]   = km.docker_scaffold_debug,
    ["docker.compose_open"]     = km.docker_compose_open,
    ["docker.compose_scaffold"] = km.docker_compose_scaffold,
    ["docker.build"]        = km.docker_build,
    ["docker.run"]          = km.docker_run,
    ["docker.ls"]           = km.docker_ls,
    ["docker.attach"]       = km.docker_attach,
    ["docker.compose_add_db"] = km.docker_compose_add_db,
    ["docker.compose_up"]   = km.docker_compose_up,
    ["docker.compose_down"] = km.docker_compose_down,
    ["docker.compose_logs"] = km.docker_compose_logs,
    -- EF Core
